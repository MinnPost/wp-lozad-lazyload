...
gulp.task( 'clean:styles', () =>
	del( [ 'assets/css/wp-lozad-lazyload.css', 'assets/css/wp-lozad-lazyload.min.css' ] )
);
...
gulp.task( 'cssnano', [ 'postcss' ], () =>
	gulp.src( 'assets/css/wp-lozad-lazyload.css' )
		.pipe( plumber( {'errorHandler': handleErrors} ) )
		.pipe( cssnano( {
			'safe': true // Use safe optimizations.
		} ) )
		.pipe( rename( 'wp-lozad-lazyload.min.css' ) )
		.pipe( gulp.dest( 'assets/css' ) )
		.pipe( browserSync.stream() )
);
...
gulp.task( 'concat', () =>
	gulp.src( paths.concat_scripts )
		...
		.pipe( concat( 'wp-lozad-lazyload-admin.js' ) )

		// Append the sourcemap to js.
		.pipe( sourcemaps.write() )
 ...
 */
gulp.task( 'clean:pot', () =>
	del( [ 'languages/wp-lozad-lazyload.pot' ] )
);
...
gulp.task( 'wp-pot', [ 'clean:pot' ], () =>
	gulp.src( paths.php )
		...
		.pipe( sort() )
		.pipe( wpPot( {
			'domain': 'wp-lozad-lazyload',
			'package': 'wp-lozad-lazyload',
		} ) )
		.pipe( gulp.dest( 'languages/wp-lozad-lazyload.pot' ) )
);
