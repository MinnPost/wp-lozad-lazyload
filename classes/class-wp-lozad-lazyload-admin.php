...
class WP_Lozad_LazyLoad_Admin {
	...
	*/
	public function create_admin_menu() {
		add_options_page( __( 'WP Lozad Lazyload Settings', 'wp-lozad-lazyload' ), __( 'WP Lozad Lazyload', 'wp-lozad-lazyload' ), 'manage_options', 'wp-lozad-lazyload', array( $this, 'show_admin_page' ) );
	}
